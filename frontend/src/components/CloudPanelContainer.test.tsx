...
describe('CloudPanelContainer', () => {
  ...
  describe('Environment Selector', () => {
    it('should render environment selector with only deployed environments (excluding local)', async () => {
      ...
      await waitFor(() => {
        ...
        const envSelect = selects.find(select =>
          select.getAttribute('title') === 'Select environment'
        );
    ...
    it('should filter services by current panel environment', async () => {
      ...
      await waitFor(() => {
        ...
        const serviceSelect = selects.find(select =>
          select.getAttribute('title') === 'Select service'
        );
  ...
  describe('Error Handling', () => {
    ...
    it('should handle service fetch errors', async () => {
      (getEnvironmentServices as Mock).mockRejectedValue(new Error('Failed to fetch'));
