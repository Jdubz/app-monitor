...
export const config = {
  ...
  gcpKeyFile:
    ...
    path.join(ROOT_DIR, ".firebase/serviceAccountKey.json"),
...
export const services: Record<string, ServiceConfig> = {
  "job-finder-backend": {
    ...
    description:
      "Node.js backend + Firebase emulators (Auth, Firestore, Functions, Storage + UI)",
    command: "npm",
    args: ["run", "start"],
    ...
    services: [
      {
        ...
        logFilter:
          'resource.type="cloud_function" resource.labels.function_name="manageGenerator-staging"',
      },
      {
        ...
        logFilter:
          'resource.type="cloud_function" resource.labels.function_name="contact-form-staging"',
      },
      {
        name: "all-functions",
        ...
        logFilter:
          'resource.type="cloud_function" resource.labels.function_name=~".*-staging"',
      },
    ],
    readOnly: true,
  },
    ...
    services: [
      {
        ...
        description: "Content generator functions",
        logFilter:
          'resource.type="cloud_function" resource.labels.function_name="manageGenerator"',
      },
      {
        name: "contact-form",
        ...
        description: "Contact form handler",
        logFilter:
          'resource.type="cloud_function" resource.labels.function_name="contact-form"',
      },
      {
        name: "all-functions",
        ...
        logFilter:
          'resource.type="cloud_function" NOT resource.labels.function_name=~".*-staging"',
      },
    ],
    readOnly: true,
  },
...
export const scripts: Record<string, ScriptConfig> = {
  ...
  "install-all": {
    ...
    args: [
      "-c",
      "cd job-finder-FE && npm install && cd ../job-finder-BE && npm install && cd ../dev-monitor/backend && npm install && cd ../frontend && npm install",
    ],
    cwd: ROOT_DIR,
    icon: "📥",
  },
  "clean-all": {
    ...
    args: [
      "-c",
      "cd job-finder-FE && rm -rf dist node_modules/.vite && cd ../job-finder-BE && rm -rf functions/dist",
    ],
    cwd: ROOT_DIR,
    icon: "🧹",
  },
