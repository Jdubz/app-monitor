...
export interface ServerToClientEvents {
  ...
  "docker:streamError": (data: { containerId: string; error: string }) => void;
  ...
  "docker:monitorError": (data: { containerId: string; error: string }) => void;

  // Connection health events
  pong: (data: { timestamp: number }) => void;

  heartbeat: (data: { timestamp: number; healthy: boolean }) => void;
