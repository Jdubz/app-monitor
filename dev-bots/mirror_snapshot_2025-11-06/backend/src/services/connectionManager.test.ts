...
describe("ConnectionManager", () => {
  ...
  describe("Connection Registration", () => {
    it("should register new connection", () => {
      ...
      const connectionInfo =
        connectionManager.getConnectionInfo("test-socket-123");
  ...
  describe("Heartbeat Management", () => {
    it("should update last ping time", () => {
      ...
      connectionManager.register(mockSocket);
      const initialPing =
        connectionManager.getConnectionInfo("test-socket-123")?.lastPing;
  ...
  describe("Connection Lifecycle", () => {
    it("should handle connection reconnection", () => {
      ...
      expect(newInfo?.connectedAt).toBeGreaterThanOrEqual(
        initialInfo!.connectedAt,
      );
    });
