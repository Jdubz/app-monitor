...
export class AgentPersonalityManager {
  ...
  private initializePersonalities(): void {
    ...
    this.personalities.set("backend-specialist", {
      ...
      description:
        "Expert in server-side development, database design, and system architecture",
      specialties: [
        "api-development",
        "database-design",
        "system-architecture",
    ...
    this.personalities.set("frontend-specialist", {
      ...
      description:
        "Expert in user interface development, responsive design, and user experience",
      specialties: [
        "ui-development",
        "responsive-design",
        "user-experience",
    ...
    this.personalities.set("review-specialist", {
      ...
      description:
        "Expert in code review, security analysis, and quality assurance",
      specialties: [
        "code-review",
        "security-analysis",
        "quality-assurance",
    ...
    this.personalities.set("devops-specialist", {
      ...
      description:
        "Expert in infrastructure, deployment, and system operations",
      specialties: [
    ...
    this.personalities.set("documentation-specialist", {
      ...
      description:
        "Expert in technical writing, documentation, and knowledge management",
      specialties: [
        "technical-writing",
        "api-documentation",
        "user-guides",
  ...
  public findBestAgent(
    ...
    for (const agentId of mapping.recommendedAgents) {
      ...
      if (
        personality &&
        this.agentMeetsRequirements(personality, requirements)
      ) {
        return agentId;
      }
    }
   ...
   */
  private agentMeetsRequirements(
