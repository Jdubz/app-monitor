  ...
  describe("Real-World Task Scenarios", () => {
    it("should generate complete template for backend feature task", () => {
      ...
      const backendTask: Task = {
        ...
        documentation:
          "Review authentication architecture and security requirements",
        acceptanceCriteria: [
    ...
    it("should generate complete template for frontend feature task", () => {
      ...
      const frontendTask: Task = {
        ...
        description:
          "Create responsive user dashboard with job search history and preferences",
      ...
      expect(prompt).toContain(
        "src/components/Dashboard/, src/pages/UserDashboard.tsx",
      );
    ...
    it("should generate complete template for worker task", () => {
      ...
      const workerTask: Task = {
        ...
        description:
          "Improve job scraping efficiency and add parallel processing",
        documentation:
          "Review current scraping architecture and performance metrics",
        acceptanceCriteria: [
        ...
        risks: ["Resource usage increase", "Potential data consistency issues"],
      };
      ...
      expect(prompt).toContain(
        "src/scrapers/, src/workers/, docker-compose.yml",
      );
