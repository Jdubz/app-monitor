...
export class QualityGateValidator extends EventEmitter {
      ...
      try {
        ...
        switch (gateKey) {
          ...
          case "testing":
            ...
            break;
          case "typechecking":
            result = await this.runTypeCheckGate(
              workspacePath,
              project,
              config,
            );
            break;
          case "documentation":
            result = await this.runDocumentationGate(
              workspacePath,
              project,
              config,
            );
   ...
   */
  private async runTypeCheckGate(
    workspacePath: string,
    project: string,
    config: QualityGateConfig,
  ): Promise<QualityGateResult> {
   ...
   */
  private async runDocumentationGate(
    workspacePath: string,
    project: string,
    config: QualityGateConfig,
  ): Promise<QualityGateResult> {
