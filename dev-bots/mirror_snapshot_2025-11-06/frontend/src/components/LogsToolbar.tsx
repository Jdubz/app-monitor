    ...
    <div style={toolbarStyle}>
      <div style={buttonGroupStyle}>
        <button
          ...
          onMouseEnter={(e) =>
            !isPaused && (e.currentTarget.style.backgroundColor = "#4a4a4a")
          }
          onMouseLeave={(e) =>
            !isPaused && (e.currentTarget.style.backgroundColor = "#3a3a3a")
          }
        >
        ...
        <button
          ...
          onMouseEnter={(e) =>
            !autoScroll && (e.currentTarget.style.backgroundColor = "#4a4a4a")
          }
          onMouseLeave={(e) =>
            !autoScroll && (e.currentTarget.style.backgroundColor = "#3a3a3a")
          }
        >
      ...
      <div style={statsStyle}>
        Showing {filteredCount.toLocaleString()} / {logCount.toLocaleString()}{" "}
        logs
