# APP-MONITOR-UI-2 — Multiple Log Panels with Source Selectors

## Issue Metadata

```yaml
Title: APP-MONITOR-UI-2 — Multiple Log Panels with Source Selectors
...
The app-monitor provides centralized monitoring for all development services, and this enhancement will allow developers to monitor multiple log sources simultaneously in separate panels.
...
```yaml
CREATE:
  - app-monitor/frontend/src/components/logs/MultiLogPanel.tsx - Multiple log panels container
  - app-monitor/frontend/src/components/logs/LogPanel.tsx - Individual log panel component
  - app-monitor/frontend/src/components/logs/SourceSelector.tsx - Source selection component
  - app-monitor/frontend/src/components/logs/PanelControls.tsx - Panel-specific controls
  - app-monitor/frontend/src/hooks/useMultiLogStream.ts - Multiple log stream management
  - app-monitor/frontend/src/hooks/usePanelSource.ts - Panel source management
  - app-monitor/frontend/src/services/panelManager.ts - Panel state management
  - app-monitor/frontend/src/types/panel.types.ts - Panel type definitions

MODIFY:
  - app-monitor/frontend/src/components/LogsViewer.tsx - Make compatible with multi-panel
  - app-monitor/frontend/src/hooks/useLogStream.ts - Support multiple concurrent streams
  - app-monitor/frontend/src/App.tsx - Integrate multi-panel layout
```
...
```bash
# Start app-monitor with multi-panel support
npm run dev
