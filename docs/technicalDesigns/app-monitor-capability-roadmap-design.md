# APP_MONITOR_CAPABILITY_ROADMAP Technical Design

**Source Plan:** docs/plans/APP_MONITOR_CAPABILITY_ROADMAP.md
**Status:** Ongoing (strategic lanes)
**Outstanding Focus:** Build Stage-2/3 capabilities before unlocking Autonomy lane.

## Objectives
- Build Stage-2/3 capabilities before unlocking Autonomy lane.
