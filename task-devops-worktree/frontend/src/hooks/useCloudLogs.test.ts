...
describe('useCloudLogs', () => {
  ...
  describe('Subscription', () => {
    ...
    it('should not subscribe if environment is empty', () => {
      ...
      expect(mockSocket.emit).not.toHaveBeenCalledWith('subscribe_cloud_logs', expect.anything());
    });
  ...
  describe('Cloud Logging Status', () => {
    it('should check cloud logging status on mount', () => {
      ...
      expect(mockSocket.emit).toHaveBeenCalledWith('check_cloud_logging_status');
    });
