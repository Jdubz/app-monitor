...
When starting Firebase emulators via app-monitor, you may see these warnings:
...
- App Monitor's port conflict detection killed the previous instance
...
The app-monitor's port conflict detection IS working correctly:
