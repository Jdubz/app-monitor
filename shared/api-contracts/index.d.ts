...
export type DevBotsInteractiveSessionStatus = 'starting' | 'running' | 'disconnecting' | 'terminating' | 'ended' | 'error';
...
export type TokenResetResponse = ApiSuccess<{
    message: string;
}>;
...
export type DockerActionResponse = ApiSuccess<{
    message: string;
}>;
...
export type DevBotsAgentsResponse = ApiSuccess<{
    agents: DevBotsAgentPersonality[];
}>;
export type DevBotsAgentComparisonResponse = ApiSuccess<{
    comparison: DevBotsAgentComparison;
}>;
export type DevBotsTemplatesResponse = ApiSuccess<{
    templates: DevBotsTaskTemplate[];
}>;
export type DevBotsMessageResponse = ApiSuccess<{
    message: string;
}>;
...
export type DevBotsInteractiveSessionInputResponse = ApiSuccess<{
    accepted: boolean;
}>;
