...
// InteractiveSessionRow - REMOVED (legacy interactive session system)
...
export class DevBotsDatabase {
  ...
  // to the new tmux-based terminal system. The old InteractiveSessionManager
  // has been replaced with TerminalService.
...
// Interactive Session types - REMOVED
// All interactive session types have been removed as part of the migration
// to the new tmux-based terminal system.
