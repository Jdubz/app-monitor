...
describe('TaskTemplateValidator', () => {
  describe('validateTaskTemplate', () => {
    ...
    it('should warn when mustFind is empty', () => {
      const template = {
        type: 'implementation',
        title: 'Test',
        description: 'Test',
      ...
      const result = validateTaskTemplate(template);
      expect(result.isValid).toBe(true); // Changed: now warning
      expect(result.warnings).toContainEqual(
        expect.objectContaining({
    ...
    it('should warn when mustNotDuplicate is empty', () => {
      const template = {
        type: 'implementation',
        title: 'Test',
        description: 'Test',
    ...
    it('should warn when preImplementationChecklist is missing', () => {
      const template = {
        type: 'implementation',
        title: 'Test',
        description: 'Test',
    ...
    it('should warn when acceptanceCriteria is missing', () => {
      const template = {
        type: 'implementation',
        title: 'Test',
        description: 'Test',
